            ...
            children: [
                {
                    path: '/',
                    name: 'Index',
                    component: () => import('@src/views/pages/landing/index.vue')
                },
                {
                    path: '/about',
                    name: 'About',
                    component: () => import('@src/views/pages/landing/About.vue')
                },
                {
                    path: '/developer',
                    name: 'Developer',
                    component: () => import('@src/views/pages/landing/Developer.vue')
                },
                {
                    path: '/moreInfo',
                    name: 'MoreInfo',
                    component: () => import('@src/views/pages/landing/MoreInfo.vue')
                },
            ]
        },
        {
            ...
            children: [
                {
                    path: '/dashboard/',
                    name: 'Dashboard',
                    component: () => import('@src/views/pages/dashboard/Dashboard.vue')
                },
                {
